...
var real__CM_Set_gravity = asm["_CM_Set_gravity"]; asm["_CM_Set_gravity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__CM_Set_gravity.apply(null, arguments);
};
...
var _CM_Set_gravity = Module["_CM_Set_gravity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_CM_Set_gravity"].apply(null, arguments) };
